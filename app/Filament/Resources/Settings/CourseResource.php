...
class CourseResource extends Resource
{
    ...
    {
        return [
            'index' => Settings\CourseResource\Pages\ListCourses::route('/'),
            'create' => Settings\CourseResource\Pages\CreateCourse::route('/create'),
            'edit' => Settings\CourseResource\Pages\EditCourse::route('/{record}/edit'),
        ];
    }
}
