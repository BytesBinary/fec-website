...
class DesignationResource extends Resource
{
    ...
    {
        return [
            'index' => Settings\DesignationResource\Pages\ListDesignations::route('/'),
            'create' => Settings\DesignationResource\Pages\CreateDesignation::route('/create'),
            'edit' => Settings\DesignationResource\Pages\EditDesignation::route('/{record}/edit'),
        ];
    }
}
