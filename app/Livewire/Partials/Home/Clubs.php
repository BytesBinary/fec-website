    ...
    public function mount(){
        $this->clubs = [
            [
                ...
                'url' => route('single-club', ['club' => 'ric']),
            ],
            [
                ...
                'url' => route('single-club', ['club' => 'feccpc']),
            ],
            [
                'logo' => asset('images/club/fecsa.jpg'),
                'short_name' => 'FECSA',
                'full_name' => 'Faridpur Engineering College Sports Association',
                'description' => 'This is a honourable club of Faridpur Engineering College. Please explore it by clicking the explore button.',
                'url' => route('single-club', ['club' => 'fecsa']),
            ],
            [
                'logo' => asset('images/club/photography.jpg'),
                'short_name' => 'FECPC',
                'full_name' => 'Faridpur Engineering College Photographic Club',
                'description' => 'This is a honourable club of Faridpur Engineering College. Please explore it by clicking the explore button.',
                'url' => route('single-club', ['club' => 'feccpc']),
            ],
            [
                ...
                'short_name' => 'FECPC',
                'full_name' => 'Faridpur Engineering College Programming Club',
                'description' => 'This is a honourable club of Faridpur Engineering College. Please explore it by clicking the explore button.',
                'url' => route('single-club', ['club' => 'fecpc2']),
            ],
            [
                'logo' => asset('images/BytesBinary.png'),
                'short_name' => 'FECSDC',
            ...
            [
                ...
                'short_name' => 'FECIDRC',
                'full_name' => 'Faridpur Engineering College Islamic Dawah and Research Center',
                'description' => 'This is a honourable club of Faridpur Engineering College. Please explore it by clicking the explore button.',
                'url' => route('single-club', ['club' => 'islamic-dawah']),
            ],
            [
                'logo' => asset('images/club/professionals.jpg'),
                'short_name' => 'FECCP',
                'full_name' => 'Faridpur Engineering College Club of Professionals',
                'description' => 'This is a honourable club of Faridpur Engineering College. Please explore it by clicking the explore button.',
                'url' => route('single-club', ['club' => 'professionals']),
            ],
            [
                'logo' => asset('images/BytesBinary.png'),
                'short_name' => 'FECBAC',
                ...
                'description' => 'This is a honourable club of Faridpur Engineering College. Please explore it by clicking the explore button.',
                'url' => route('single-club', ['club' => 'bani-archana']),
            ],
            [
                'logo' => asset('images/BytesBinary.png'),
                'short_name' => 'FECRSG',
                ...
                'description' => 'This is a honourable club of Faridpur Engineering College. Please explore it by clicking the explore button.',
                'url' => route('single-club', ['club' => 'fecrsg']),
            ],
        ];
