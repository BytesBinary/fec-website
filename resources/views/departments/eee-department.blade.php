    ...
    @section('title', 'Electrical and Electronics Engineering | FEC')
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 lg:gap-6">
            ...
            <div class="w-full mb-10 lg:col-span-3 col-span-3 bg-white rounded-lg shadow-md p-8 border border-gray-200">
                ...
                <p class="text-center text-gray-700 mb-4 text-lg">
                    Explore our programs, research, and opportunities within the field of Electrical and Electronics Engineering.
                </p>
