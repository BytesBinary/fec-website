        ...
        <div class="w-full mx-auto mb-10 col-span-1 bg-lime-50 rounded-lg shadow-md p-5 border border-gray-200">
            ...
            <nav class="mt-4 mx-auto">
                ...
                <div x-show="currentDropdown === 'academics'" class="bg-orange-100 p-2 rounded">
                    <a href="#" wire:click.prevent="$emit('changeContent','message-from-head')" class="block px-8 py-2 text-md hover:bg-bgColorLighter text-txtColor">Message from Head</a>
                    <a href="#"wire:click.prevent="$emit('changeContent','biography')"  class="block px-8 py-2 text-md hover:bg-bgColorLighter text-txtColor">Biography</a>
                    <a href="#" wire:click.prevent="$emit('changeContent','edu-background')"  class="block px-8 py-2 text-md hover:bg-bgColorLighter text-txtColor">Educational Background</a>
                </div>
