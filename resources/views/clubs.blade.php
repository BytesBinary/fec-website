        ...
        <div class="grid gap-6 grid-cols-1 md:grid-cols-1 lg:grid-cols-2 mb-16">
            ...
            <div class="flex flex-col w-full my-3 items-center bg-white shadow-gray-500 rounded-lg hover:scale-105 duration-150 hover:cursor-pointer shadow-2xl md:flex-row"
                ...
                <img class="object-cover mx-3 w-full h-80 rounded-t-lg md:w-80 md:h-auto md:rounded-l-lg"
                    src="images/card/cse-dept.jpg" alt="Research & Innovation Center Image">
                <div class="flex flex-col justify-between p-6 leading-normal">
                    ...
                    <div class="card-actions mt-auto flex justify-center">
                        <button onclick="window.location.href='{{route('clubs.ric')}}'"
            ...
            <div class="flex flex-col w-full my-3 items-center bg-white shadow-gray-500 rounded-lg hover:scale-105 duration-150 hover:cursor-pointer shadow-2xl md:flex-row"
                ...
                <div class="flex flex-col justify-between p-6 leading-normal">
                    ...
                    <div class="card-actions mt-auto flex justify-center">
                        <button onclick="window.location.href='{{route('clubs.cyber-protector')}}'"
                            class="btn w-full max-w-xs bg-gradient-to-r from-lime-500 to-emerald-500 text-white hover:bg-gradient-to-l hover:from-lime-600 hover:to-emerald-600 rounded-lg py-3 transition-all flex items-center justify-center space-x-2 shadow-md hover:shadow-lg">
                            <span class="text-xl text-gray-800">View Club</span>
                            <x-svg-icon.external-url />
                        </button>
            ...
            <div class="flex flex-col w-full my-3 items-center bg-white shadow-gray-500 rounded-lg hover:scale-105 duration-150 hover:cursor-pointer shadow-2xl md:flex-row"
                data-aos="fade-down">
                <img class="object-cover mx-3 w-full h-80 rounded-t-lg md:w-80 md:h-auto md:rounded-l-lg"
                    src="images/card/roverscout.jpg" alt="Sports Association Image">
                <div class="flex flex-col justify-between p-6 leading-normal">
                    ...
                    <div class="card-actions mt-auto flex justify-center">
                        <button onclick="window.location.href='{{route('clubs.fecsa')}}'"
                            class="btn w-full max-w-xs bg-gradient-to-r from-lime-500 to-emerald-500 text-white hover:bg-gradient-to-l hover:from-lime-600 hover:to-emerald-600 rounded-lg py-3 transition-all flex items-center justify-center space-x-2 shadow-md hover:shadow-lg">
                            <span class="text-xl text-gray-800">View Club</span>
                            <x-svg-icon.external-url />
                        </button>
            ...
            <div class="flex flex-col w-full my-3 items-center bg-white shadow-gray-500 rounded-lg hover:scale-105 duration-150 hover:cursor-pointer shadow-2xl md:flex-row"
                data-aos="fade-up">
                <img class="object-cover mx-3 w-full h-80 rounded-t-lg md:w-80 md:h-auto md:rounded-l-lg"
                    src="images/card/photography.jpg" alt="Photographic Club Image">
                <div class="flex flex-col justify-between p-6 leading-normal">
                    ...
                    <div class="card-actions mt-auto flex justify-center">
                        <button onclick="window.location.href='{{route('clubs.photography')}}'"
                            class="btn w-full max-w-xs bg-gradient-to-r from-lime-500 to-emerald-500 text-white hover:bg-gradient-to-l hover:from-lime-600 hover:to-emerald-600 rounded-lg py-3 transition-all flex items-center justify-center space-x-2 shadow-md hover:shadow-lg">
                            <span class="text-xl text-gray-800">View Club</span>
                            <x-svg-icon.external-url />
                        </button>
            ...
            <div class="flex flex-col w-full my-3 items-center bg-white shadow-gray-500 rounded-lg hover:scale-105 duration-150 hover:cursor-pointer shadow-2xl md:flex-row"
                data-aos="fade-up">
                <img class="object-cover mx-3 w-full h-80 rounded-t-lg md:w-80 md:h-auto md:rounded-l-lg"
                    src="images/card/photography.jpg" alt="Programming Club Image">
                <div class="flex flex-col justify-between p-6 leading-normal">
                    ...
                    <div class="card-actions mt-auto flex justify-center">
                        <button onclick="window.location.href='{{route('clubs.programming')}}'"
                            class="btn w-full max-w-xs bg-gradient-to-r from-lime-500 to-emerald-500 text-white hover:bg-gradient-to-l hover:from-lime-600 hover:to-emerald-600 rounded-lg py-3 transition-all flex items-center justify-center space-x-2 shadow-md hover:shadow-lg">
                            <span class="text-xl text-gray-800">View Club</span>
                            <x-svg-icon.external-url />
                        </button>
            ...
            <div class="flex flex-col w-full my-3 items-center bg-white shadow-gray-500 rounded-lg hover:scale-105 duration-150 hover:cursor-pointer shadow-2xl md:flex-row"
                ...
                <div class="flex flex-col justify-between p-6 leading-normal">
                    ...
                    <div class="card-actions mt-auto flex justify-center">
                        <button onclick="window.location.href='{{route('clubs.debating')}}'"
                            class="btn w-full max-w-xs bg-gradient-to-r from-lime-500 to-emerald-500 text-white hover:bg-gradient-to-l hover:from-lime-600 hover:to-emerald-600 rounded-lg py-3 transition-all flex items-center justify-center space-x-2 shadow-md hover:shadow-lg">
                            <span class="text-xl text-gray-800">View Club</span>
                            <x-svg-icon.external-url />
                        </button>
            ...
            <div class="flex flex-col w-full my-3 items-center bg-white shadow-gray-500 rounded-lg hover:scale-105 duration-150 hover:cursor-pointer shadow-2xl md:flex-row"
                data-aos="fade-up">
                <img class="object-cover mx-3 w-full h-80 rounded-t-lg md:w-80 md:h-auto md:rounded-l-lg"
                    src="images/card/photography.jpg" alt="Islamic Dawah and Research Center  Image">
                <div class="flex flex-col justify-between p-6 leading-normal">
                    ...
                    <div class="card-actions mt-auto flex justify-center">
                        <button onclick="window.location.href='{{route('clubs.islamic-research')}}'"
                            class="btn w-full max-w-xs bg-gradient-to-r from-lime-500 to-emerald-500 text-white hover:bg-gradient-to-l hover:from-lime-600 hover:to-emerald-600 rounded-lg py-3 transition-all flex items-center justify-center space-x-2 shadow-md hover:shadow-lg">
                            <span class="text-xl text-gray-800">View Club</span>
                            <x-svg-icon.external-url />
                        </button>
            ...
            <div class="flex flex-col w-full my-3 items-center bg-white shadow-gray-500 rounded-lg hover:scale-105 duration-150 hover:cursor-pointer shadow-2xl md:flex-row"
                data-aos="fade-up">
                <img class="object-cover mx-3 w-full h-80 rounded-t-lg md:w-80 md:h-auto md:rounded-l-lg"
                    src="images/card/photography.jpg" alt="Bani Archana Committee  Image">
                <div class="flex flex-col justify-between p-6 leading-normal">
                    ...
                    <div class="card-actions mt-auto flex justify-center">
                        <button onclick="window.location.href='{{route('clubs.bani-archana')}}'"
                            class="btn w-full max-w-xs bg-gradient-to-r from-lime-500 to-emerald-500 text-white hover:bg-gradient-to-l hover:from-lime-600 hover:to-emerald-600 rounded-lg py-3 transition-all flex items-center justify-center space-x-2 shadow-md hover:shadow-lg">
                            <span class="text-xl text-gray-800">View Club</span>
                            <x-svg-icon.external-url />
                        </button>
            ...
            <div class="flex flex-col w-full my-3 items-center bg-white shadow-gray-500 rounded-lg hover:scale-105 duration-150 hover:cursor-pointer shadow-2xl md:flex-row"
                data-aos="fade-up">
                <img class="object-cover mx-3 w-full h-80 rounded-t-lg md:w-80 md:h-auto md:rounded-l-lg"
                    src="images/card/professionals.jpg" alt="Professionals Club Image">
                <div class="flex flex-col justify-between p-6 leading-normal">
                    ...
                    <div class="card-actions mt-auto flex justify-center">
                        <button onclick="window.location.href='{{route('clubs.club-of-professional')}}'"
                            class="btn w-full max-w-xs bg-gradient-to-r from-lime-500 to-emerald-500 text-white hover:bg-gradient-to-l hover:from-lime-600 hover:to-emerald-600 rounded-lg py-3 transition-all flex items-center justify-center space-x-2 shadow-md hover:shadow-lg">
                            <span class="text-xl text-gray-800">View Club</span>
                            <x-svg-icon.external-url />
                        </button>
            ...
            <div class="flex flex-col w-full my-3 items-center bg-white shadow-gray-500 rounded-lg hover:scale-105 duration-150 hover:cursor-pointer shadow-2xl md:flex-row"
                ...
                <div class="flex flex-col justify-between p-6 leading-normal">
                    ...
                    <div class="card-actions mt-auto flex justify-center">
                        <button onclick="window.location.href='{{route('clubs.rover-scout')}}'"
                            class="btn w-full max-w-xs bg-gradient-to-r from-lime-500 to-emerald-500 text-white hover:bg-gradient-to-l hover:from-lime-600 hover:to-emerald-600 rounded-lg py-3 transition-all flex items-center justify-center space-x-2 shadow-md hover:shadow-lg">
                            <span class="text-xl text-gray-800">View Club</span>
                            <x-svg-icon.external-url />
                        </button>
