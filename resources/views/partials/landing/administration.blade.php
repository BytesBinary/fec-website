<div class="container mx-auto bg-white p-5 my-10 rounded-lg shadow-inner">
    ...
    <div class="grid gap-5 grid-cols-1 mt-5 lg:grid-cols-4">
        <x-administration-card name="Prof. Dr. Engr. Md. Mizanur Rahman" designation="Principal" image="images/administration/mia-bhai.jpg" url="{{route('principal')}}" />
    ...
    <div class="grid gap-5 grid-cols-1 mt-5 pb-5 lg:grid-cols-3">
        <x-administration-card name="Md. Shamsul Islam" designation="Head of the Dept. CSE" image="images/administration/mia-bhai3.jpg" url="{{route('dept-cse')}}" />
        <x-administration-card name="Md. Sanowar Hossain" designation="Head of the Dept. EEE" image="images/administration/mia-bhai2.jpg" url="{{route('dept-eee')}}" />
        <x-administration-card name="Md. Rayhan Khan Apu" designation="Head of the Dept. CE" image="images/administration/mia-bhai1.jpg" url="{{route('dept-ce')}}" />
    </div>
</div>
