<div class="container mx-auto bg-white p-5 my-10 rounded-lg shadow-inner">
    ...
    <div class="grid gap-5 grid-cols-1 mt-5 lg:grid-cols-4">
        ...
        <div class="md:col-span-3 card w-full shadow-2xl shadow-gray-500 mt-5 hover:shadow-gray-700 hover:cursor-pointer" data-aos="fade-up">
            <div class="card-body">
