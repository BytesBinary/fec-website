        ...
        <div class="col-span-1 cursor-pointer">
            <ul class="space-y-4">
                <template x-for="(notice, index) in filteredNotices" :key="notice.id">
                    <li :class="currentId === notice.id ? 'bg-cyan-200' : 'bg-cyan-50'" class="p-4 rounded-lg shadow hover:bg-cyan-300" @click="changeNotice(notice.id, notice.title, notice.pdf)">
