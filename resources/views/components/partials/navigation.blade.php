<!-- Menu Links -->
<nav id="navBar"
    class="hidden container w-[1170px] mx-auto bg-white text-gray-800 px-4 py-7 rounded shadow-lg md:flex justify-evenly text-lg md:text-base md:shadow-lg z-50 absolute left-1/2 transform -translate-x-1/2 -translate-y-1/2 transition-all duration-500 ease-in"
