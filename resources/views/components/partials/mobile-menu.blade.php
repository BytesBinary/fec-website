...
<div x-show="open" class="md:hidden" @click.away="open = false">
    <div class="fixed inset-y-0 left-0 w-3/5 bg-[#333F48] text-white transform transition-transform off-canvas-enter-active off-canvas-leave-active" x-show="open" x-transition:enter="off-canvas-enter" x-transition:leave="off-canvas-leave-to">
        ...
        <nav class="mt-4 border-b border-gray-100">
            {{$slot}}
        </nav>
    </div>
</div>
