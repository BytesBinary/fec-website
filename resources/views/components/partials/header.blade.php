    ...
    <div class="container lg:w-[1170px] mx-auto lg:flex items-center justify-between px-4 lg:px-0 sm:py-2 md:py-3 opacity-75">
        ...
        <div class="hidden md:hidden lg:flex items-center space-x-4 text-md">
            ...
            <span class="flex">
                ...
                <p class="text-sm lg:mr-3">Baitul Aman Rd, Faridpur</p>
            </span>
        </div>
    </div>
</div>
...
<div class="sticky top-0 z-50 bg-deepBlue text-white px-5 lg:pb-3 md:static md:top-auto md:z-0">
    <div class="w-full container mx-auto flex justify-between items-center py-4 lg:py-8">
        <!-- Logo and Address -->
       <div class="lg:w-[1170px] flex justify-between items-center lg:mx-auto ">
