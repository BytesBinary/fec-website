        ...
        <div class="container">
            <div class="row g-5">
                <x-card row-class="col-lg-4 col-md-6 mb-4" card-class="h-100 shadow-lg border-0" image="true"
                    ...
                    button="true" button-url="{{route('ric-research-&-innovation-center')}}" button-class="btn px-5 btn-success shadow-xl rounded-pill" button-text="Visit the Club" />
                ...
                <x-card row-class="col-lg-4 col-md-6 mb-4" card-class="h-100 shadow-lg border-0" image="true"
                    ...
                    card-text="Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse cupiditate dolore eveniet autem expedita consectetur." card-con-class="d-flex align-items-center justify-content-center"
                    button="true" button-url="{{route('fecsa-sports-association')}}" url-class="text-center" button-class="btn px-5 btn-success shadow-xl rounded-pill"
                ...
                <x-card row-class="col-lg-4 col-md-6 mb-4" card-class="h-100 shadow-lg border-0" image="true"
                    ...
                    card-text="Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse cupiditate dolore eveniet autem expedita consectetur." card-con-class="d-flex align-items-center justify-content-center"
                    button="true" button-url="{{route('fecpc-photographic-club')}}" button-class="btn px-5 btn-success shadow-xl rounded-pill"
                    button-text="Visit the Club"/>
                ...
                image-url="{{ asset('images/events/events.jpeg') }}" image-alt="Features 3"
                    ...
                    card-text="Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse cupiditate dolore eveniet autem expedita consectetur." card-con-class="d-flex align-items-center justify-content-center"
                    button="true" button-url="{{route('fecpc-programming-club')}}" button-class="btn px-5 btn-success shadow-xl rounded-pill"
                    button-text="Visit the Club"/>
                ...
                image-url="{{ asset('images/events/events.jpeg') }}" image-alt="Features 3"
                    ...
                    card-text="Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse cupiditate dolore eveniet autem expedita consectetur." card-con-class="d-flex align-items-center justify-content-center"
                    button="true" button-url="{{route('feccdc-cyber-defense-club')}}" button-class="btn px-5 btn-success shadow-xl rounded-pill"
                    button-text="Visit the Club"/>
                ...
                image-url="{{ asset('images/events/events.jpeg') }}" image-alt="Features 3"
                    ...
                    card-text="Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse cupiditate dolore eveniet autem expedita consectetur." card-con-class="d-flex align-items-center justify-content-center"
                    button="true" button-url="{{route('fecirdc-islamic-research-&-dawah-center')}}" button-class="btn px-5 btn-success shadow-xl rounded-pill"
                    button-text="Visit the Club"/>
                ...
                <x-card row-class="col-lg-4 col-md-6 mb-4" card-class="h-100 shadow-lg border-0" image="true"
                    ...
                    card-text="Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse cupiditate dolore eveniet autem expedita consectetur." card-con-class="d-flex align-items-center justify-content-center"
                    button="true" button-url="{{route('fecdc-debating-club')}}" button-class="btn px-5 btn-success shadow-xl rounded-pill"
                    button-text="Visit the Club"/>
                ...
                <x-card row-class="col-lg-4 col-md-6 mb-4" card-class="h-100 shadow-lg border-0" image="true"
                    ...
                    card-text="Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse cupiditate dolore eveniet autem expedita consectetur." card-con-class="d-flex align-items-center justify-content-center"
                    button="true" button-url="{{route('feccp-club-of-profession')}}" button-class="btn px-5 btn-success shadow-xl rounded-pill"
                    button-text="Visit the Club"/>
                ...
                <x-card row-class="col-lg-4 col-md-6 mb-4" card-class="h-100 shadow-lg border-0" image="true"
                    ...
                    card-text="Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse cupiditate dolore eveniet autem expedita consectetur." card-con-class="d-flex align-items-center justify-content-center"
                    button="true" button-url="{{route('fecrsg-rover-scout-group')}}" button-class="btn px-5 btn-success shadow-xl rounded-pill"
                    button-text="Visit the Club"/>
            </div>
        </div>
    </div>
