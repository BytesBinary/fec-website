<section class="section online-services-section">
    <div class="container">
        ...
        <div class="row justify-content-center align-items-center card-container">
            <x-card row-class="col-lg-4 mt-3 card-holder" animation="zoom-in-up" card-class="shadow-lg rounded-md h-100" body-class="text-center" image="true" image-url="{{asset('assets/img/services/notice.svg')}}"
            ...
            <x-card row-class="col-lg-4 mt-3 card-holder" animation="zoom-in-up" card-class="shadow-lg rounded-md h-100" body-class="text-center" image="true" image-url="{{asset('assets/img/services/result .svg')}}"
            ...
            <x-card row-class="col-lg-4 mt-3 card-holder" animation="zoom-in-up" card-class="shadow-lg rounded-md h-100" body-class="text-center" image="true" image-url="{{asset('assets/img/services/application.svg')}}"
            ...
            <x-card row-class="col-lg-4 mt-4 card-holder" animation="zoom-in-up" card-class="shadow-lg rounded-md h-100" body-class="text-center" image="true" image-url="{{asset('assets/img/services/syllabus.svg')}}"
            ...
            <x-card row-class="col-lg-4 mt-4 card-holder" animation="zoom-in-up" card-class="shadow-lg rounded-md h-100" body-class="text-center" image="true" image-url="{{asset('assets/img/services/calendar.svg')}}"
