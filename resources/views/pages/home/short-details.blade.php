...
<section class="section short-description position-relative">
    ...
    <div class="container position-relative">
        <div class="row justify-content-center align-items-center ">
            ...
            <x-short-details iconClass="bi bi-mortarboard" text="{{ $short_details['students_text'] }}: <br/> <span class='count-up' data-count='{{ $short_details['students_value'] }}'>0</span><span>+</span>" animation="fade-up" />
            <x-short-details iconClass="bi bi-people" text="{{ $short_details['faculty_member_text'] }}: <br/> <span class='count-up' data-count='{{ $short_details['faculty_member_value'] }}'>0</span><span>+</span>" animation="fade-up" />
        </div>
    </div>
</section>
@endif
