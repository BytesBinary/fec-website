    ...
    <ul class="nav">
      ...
      <li class="nav-item">
        ...
        <div class="collapse" id="icons">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item">
              <a class="nav-link" href="{{ route('admin.icons') }}">Font Awesome</a>
            </li>
          </ul>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div class="collapse" id="charts">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item">
              <a class="nav-link" href="{{ route('admin.charts') }}">ChartJs</a>
            </li>
          </ul>
        </div>
      </li>
      <li class="nav-item">
        ...
        <div class="collapse" id="tables">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item">
              <a class="nav-link" href="{{ route('admin.tables') }}">Basic table</a>
            </li>
          </ul>
        </div>
      </li>
      <li class="nav-item">
        ...
        <div class="collapse" id="auth">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item">
              <a class="nav-link" href="{{ route('admin.blankpage') }}">Blank Page</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ route('admin.error404') }}">404</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{ route('admin.error500') }}">500</a>
            </li>
          </ul>
        </div>
      </li>
