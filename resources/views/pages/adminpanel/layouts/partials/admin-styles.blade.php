<!-- plugins:css -->
<link rel="stylesheet" href="{{ asset('assets/admin-panel/assets/vendors/mdi/css/materialdesignicons.min.css') }}">
<link rel="stylesheet" href="{{ asset('assets/admin-panel/assets/vendors/ti-icons/css/themify-icons.css') }}">
<link rel="stylesheet" href="{{ asset('assets/admin-panel/assets/vendors/css/vendor.bundle.base.css') }}">
