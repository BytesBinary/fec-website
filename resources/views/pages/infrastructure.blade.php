...
@section('content')
    <div class="container page-top-section">
        <div class="row">
            <div class="col-12">
                <h1 class="text-center">Infrastructure | Faridpur Engineering College</h1>
                <hr>
                ...
                <ul>
                    ...
                    <li>A modern computer lab with fast-paced Internet access and modern learning facilities, including sophisticated Labs/Workshops</li>
                </ul>
            </div>
        </div>
    </div>
