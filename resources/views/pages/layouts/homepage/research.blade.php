<section>
    <x-section-title title="Research Activities"
        des="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."
        animation="fade-up" />

    <div class="container">
        <div class="row g-5">
            <x-card row-class="col-lg-4 col-md-6 mb-4" card-class="h-100 shadow-sm border-0" image="true"
                image-url="{{ asset('assets/img/tabs-1.jpg') }}" image-alt="Features 3"
            ...
            <x-card row-class="col-lg-4 col-md-6 mb-4" card-class="h-100 shadow-sm border-0" image="true"
                image-url="{{ asset('assets/img/tabs-2.jpg') }}" image-alt="Features 3"
                image-class="card-img-top img-fluid"
                custom-html-in-card='<hr class="custom-line"><p class="text-muted mb-2 date"><i class="bi bi-calendar"></i> 21 Aug, 2024</p><hr class="custom-line">'
            ...
            <x-card row-class="col-lg-4 col-md-6 mb-4" card-class="h-100 shadow-sm border-0" image="true"
                image-url="{{ asset('assets/img/tabs-3.jpg') }}" image-alt="Features 3"
                image-class="card-img-top img-fluid"
                custom-html-in-card='<hr class="custom-line"><p class="text-muted mb-2 date"><i class="bi bi-calendar"></i> 21 Aug, 2024</p><hr class="custom-line">'
