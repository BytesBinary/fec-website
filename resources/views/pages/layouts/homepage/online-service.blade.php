<section class="section online-services-section">
    <div class="container">
        <x-section-title title="Online Services" des="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua." animation="fade-up"/>
        <div class="row justify-content-center align-items-center card-container">
            <x-card row-class="col-lg-4 mt-3 card-holder" animation="zoom-in-up" card-class="shadow-sm rounded-md h-100" body-class="text-center" image="true" image-url="{{asset('assets/img/notice.svg')}}"
