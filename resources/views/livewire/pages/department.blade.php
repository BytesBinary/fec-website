<div>
    <h1 class="text-center w-full text-4xl font-extrabold text-deepBlue mb-5" data-aos="fade-up" data-aos-delay="100">
        Welcome to the Department of {{$cardTitle}}
    </h1>
    <hr class="h-1 w-full mx-auto my-4 bg-blue-400 rounded mb-12" data-aos="fade-up" data-aos-delay="200">
