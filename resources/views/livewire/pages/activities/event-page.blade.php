                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="bg-gray-200 p-3 rounded-md shadow-md hover:shadow-lg">
                            ...
                            <p class="text-sm text-gray-700">Innovative projects from various industries.</p>
                        </div>
                        <div class="bg-gray-200 p-3 rounded-md shadow-md hover:shadow-lg">
            ...
            <div class="w-full lg:w-1/3 order-2 lg:order-2">
                ...
                <div class="bg-white p-4">
                    ...
                    <div class="flex space-x-6">
                        ...
                        <a href="twitter-link" class="text-cyan-500 hover:text-cyan-600">
                            <i class="fab fa-twitter-square"></i> Twitter
                        </a>
                        <a href="linkedin-link" class="text-blue-700 hover:text-blue-800">
                ...
                <div class="bg-white p-4">
                    ...
                    <div class="bg-gray-200 p-3 mb-3 rounded-md shadow-md hover:shadow-lg">
                        ...
                        <div class="mt-4 text-sm text-gray-600">
                            <p><strong>Email:</strong> <a href="mailto:alexmorgan@techsummit.com" class="text-blue-500 hover:underline">alexmorgan@techsummit.com</a></p>
                            <p class="mt-1"><strong>Phone:</strong> <a href="tel:+1234567890" class="text-blue-500 hover:underline">+1 234-567-890</a></p>
                    ...
                    <div class="bg-gray-200 p-3 rounded-md shadow-md hover:shadow-lg">
                        <div class="flex items-center mt-4">
                            <img src="{{ asset('images/BytesBinary.png') }}" alt="Host Image" class="w-12 h-12 rounded-full mr-4 border-2 border-orange-500">
                            <div>
                                <p class="text-gray-700 font-semibold">Bytes & Binary</p>
                                <p class="text-sm text-gray-600">Primary Host</p>
                            </div>
                        </div>
                        <div class="mt-4 text-sm text-gray-600">
                            <p><strong>Email:</strong> <a href="mailto:bytesbinary@techsummit.com" class="text-blue-500 hover:underline">bytesbinary@techsummit.com</a></p>
