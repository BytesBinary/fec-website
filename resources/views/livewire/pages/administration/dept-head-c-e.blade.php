    ...
    <div x-data="{ currentSection: 'about' }" class="container mx-auto mt-8 lg:mt-24 mb-20 w-full">
        <div class="grid grid-cols-1 lg:grid-cols-4 lg:gap-6">
            ...
            <div x-show="currentSection === 'about'" class="w-full mb-10 lg:col-span-3 col-span-3 bg-white rounded-3xl shadow-md border border-gray-200">
                <div class="rounded-3xl shadow-2xl p-6 lg:border-l-4 lg:border-r-4 lg:border-t-0 border-emerald-500">
                    <div class="flex w-3/4 mx-auto gap-6 justify-center items-center">
                        <img class="h-auto w-1/5 object-cover object-top rounded-lg shadow-md" src="{{ asset('images/administration/ce-head.jpg') }}" alt="Principal Image">
                        <div>
                            <h1 class="text-3xl font-extrabold text-deepBLue mt-6">Md. Rayhan Khan Apu</h1>
                            <h3 class="text-xl text-gray-800">Head of the Dept. CE</h3>
                            <h4 class="text-md text-gray-700 mb-4">Faridpur Engineering College</h4>
                        </div>
                    </div>
                    <hr class="h-1 w-3/4 mx-auto my-5 bg-blue-400 rounded mb-12" data-aos="fade-up" data-aos-delay="200">
            ...
            <div x-show="currentSection === 'biography'" class="w-full mb-10 lg:col-span-3 col-span-3 bg-white rounded-lg shadow-md p-8 border border-gray-200">
                <h1 class="text-center w-full text-4xl font-extrabold text-deepBLue mb-5">
                    Biography
                </h1>
                <hr class="h-1 w-1/2 mx-auto my-4 bg-blue-400 rounded mb-12">
