...
<div x-data="{ activeSection: 'overview' }" id="about" class="overflow-hidden mt-10 mb-20 lg:my-24 flex-col-reverse flex lg:flex-row justify-center lg:ml-20">
    ...
    <div class="p-3 lg:p-0 text-center grid grid-cols-2 gap-2 lg:flex lg:flex-col lg:space-y-3 lg:mt-6">
        <a href="#" @click.prevent="activeSection = 'overview'"
           class="px-4 py-2 bg-secondColor text-center bg-[#ff6e21] text-white font-semibold rounded-lg lg:rounded-l-none shadow-md hover:bg-[#e65b0f] transition-colors duration-300">
           Overview
        </a>
        ...
        <a href="#" @click.prevent="activeSection = 'achievements'"
           class="px-4 py-2 bg-secondColor text-center bg-[#ff6e21] text-white font-semibold lg:rounded-l-none rounded-lg shadow-md hover:bg-[#e65b0f] transition-colors duration-300">
           Achievements
        </a>
