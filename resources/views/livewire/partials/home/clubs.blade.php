        ...
        <div class="swiper-wrapper mb-10">
            ...
            <div class="swiper-slide">
                <x-card.club-card logo="images/BytesBinary.png" short-name="FECBAC" full-name="Faridpur Engineering College Bani Archana Committee"
                             description="This is a honourable club of faridpur engineering college. Please explore it by clicking the explore button." url="{{route('single-club',['name'=>'bani-archana'])}}" />
            </div>
            <div class="swiper-slide">
                <x-card.club-card logo="images/BytesBinary.png" short-name="FECRSG" full-name="Faridpur Engineering College Rover Scout Group"
                             description="This is a honourable club of faridpur engineering college. Please explore it by clicking the explore button." url="{{route('single-club',['name'=>'fecrsg'])}}" />
            </div>
        </div>
