        ...
        <div class="swiper-wrapper mb-10">
            <div class="swiper-slide">
                <x-card.club-card logo="{{asset('images/club/ric.jpg')}}" short-name="RIC" full-name="Research and Innovation Center"
                             description="At RIC FEC, we cultivate a culture of innovation, motivation, and leadership among engineers and aspiring researchers." url="{{route('ric')}} "/>
            </div>
            <div class="swiper-slide">
                <x-card.club-card logo="images/BytesBinary.png" short-name="FECCPC" full-name="Faridpur Engineering College Cyber Protector Club"
                             description="This is a honourable club of faridpur engineering college. Please explore it by clicking the explore button." url="{{route('feccpc')}}" />
            </div>
            <div class="swiper-slide">
                <x-card.club-card logo="{{asset('images/club/fecsa.jpg')}}" short-name="FECSA" full-name="Faridpur Engineering College Sports Association"
                             description="This is a honourable club of faridpur engineering college. Please explore it by clicking the explore button." url="{{route('fecsa')}}" />
            </div>
            <div class="swiper-slide">
            ...
            <div class="swiper-slide">
                <x-card.club-card logo="{{asset('images/club/programming.jpg')}}" short-name="FECPC" full-name="Faridpur Engineering College Programming Club"
                             description="This is a honourable club of faridpur engineering college. Please explore it by clicking the explore button." url="{{route('fecpc2')}}" />
            </div>
            <div class="swiper-slide">
            ...
            <div class="swiper-slide">
                <x-card.club-card logo="{{asset('images/club/fecrdc.jpg')}}" short-name="FECIDRC" full-name="Faridpur Engineering College Islamic Dawah and Research Center"
                             description="This is a honourable club of faridpur engineering college. Please explore it by clicking the explore button." url="{{route('islamic-dawah')}}" />
            </div>
            <div class="swiper-slide">
                <x-card.club-card logo="{{asset('images/club/professionals.jpg')}}" short-name="FECCP" full-name="Faridpur Engineering College Club of Professionals"
                             description="This is a honourable club of faridpur engineering college. Please explore it by clicking the explore button." url="{{route('professionals')}}" />
            </div>
            <div class="swiper-slide">
                <x-card.club-card logo="images/BytesBinary.png" short-name="FECBAC" full-name="Faridpur Engineering College Bani Archana Committee"
                             description="This is a honourable club of faridpur engineering college. Please explore it by clicking the explore button." url="{{route('bani-archana')}}" />
            </div>
            <div class="swiper-slide">
                <x-card.club-card logo="images/BytesBinary.png" short-name="FECRSG" full-name="Faridpur Engineering College Rover Scout Group"
                             description="This is a honourable club of faridpur engineering college. Please explore it by clicking the explore button." url="{{route('fecrsg')}}" />
            </div>
        </div>
