{{-- <div>
    <!-- Swiper Hero Section -->
    <div class="relative h-[560px] lg:min-h-screen w-full overflow-hidden">
        <div class="relative h-[560px] lg:min-h-screen overflow-hidden">
...
<div>
    ...
    <div class="relative h-[560px] lg:min-h-screen w-full overflow-hidden">
        ...
        <!-- Gradient Overlay -->
        <div
            class="absolute inset-0 bg-gradient-to-b from-violet-400 to-transparent h-1/3 pointer-events-none"
            aria-hidden="true">
        </div>
