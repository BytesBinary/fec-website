<div>
    <!-- Swiper Hero Section -->
    <div class="swiper-container swiper-container-hero-section relative h-[560px] lg:min-h-screen w-full overflow-hidden">
        <div class="swiper-wrapper">
            @foreach ($images as $index => $image)
                <div class="swiper-slide relative h-[560px] lg:min-h-screen overflow-hidden"> <!-- Added overflow-hidden here -->
                    <!-- Background Image -->
                    <img
                        src="{{ $image['src'] ?? '#' }}"
                        alt="{{ $image['title'] ?? 'Hero Slide' }} Background"
                        class="absolute inset-0 w-full h-full object-cover filter blur-[4px]"
                        loading="lazy"
                    >
                    ...
                    <!-- Content -->
                    <div class="relative z-10 flex flex-col items-center justify-center h-[560px] lg:min-h-screen text-center space-y-6 px-6 pb-10 animate-fade-in-zoom">
                        <!-- Tagline -->
                        ...
                        >
                            <span class="absolute inset-0 bg-yellow-300 opacity-0 group-hover:opacity-10 rounded-lg transition duration-300"></span>
                        ...
                        <!-- Primary Button -->
                                ...
                                <a
                                href="#gallery"
                                class="inline-block border-2 border-yellow-400 text-yellow-400 py-3 px-10 rounded-lg text-lg font-semibold hover:bg-yellow-400 hover:text-gray-900 transition duration-300 hidden lg:block"
                                >Explore Now</span>
                        </a>
                        </div>
                    </div>
