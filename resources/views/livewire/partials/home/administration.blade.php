        ...
        <div class="container mx-auto p-5 my-10">
            ...
            <div class="grid gap-6 grid-cols-1 mt-10 lg:grid-cols-4 hover:cursor-pointer">
                    ...
                    <div class="flex justify-center transform transition duration-300 hover:shadow-2xl">
                        <div class="max-w-[18rem] w-full bg-green-50 shadow-xl rounded-lg overflow-hidden h-[28rem]">
                            ...
                            <div class="p-6">
                                ...
                                <h2 class="text-2xl font-semibold text-green-800">{{ $principal['name'] }}</h2>
                                <p class="text-green-600 mt-2">{{ $principal['title'] }}</p>
                                <hr class="border-green-300">
                            </div>
                        </div>
                    </div>
                ...
                <div class="lg:col-span-3 flex">
                    <div class="w-full bg-green-50 shadow-xl rounded-lg overflow-scroll lg:overflow-hidden md:overflow-hidden transform transition duration-300 hover:shadow-2xl h-[28rem] flex flex-col justify-between">
                        <div class="p-8">
                            <h1 class="text-xl md:text-3xl font-bold text-green-900 mt-4">Message From Principal</h1>
                ...
                @foreach ($departmentHead as $head)
                    <a href="{{ $head['route'] }}" wire:navigate>
                        <div class="flex justify-center hover:cursor-pointer">
                            <div class="max-w-[20rem] w-full bg-green-50 shadow-xl rounded-lg overflow-hidden transform transition duration-300 hover:scale-105 h-[23rem]">
                                <img class="w-full h-56 object-cover" src="{{ $head['image'] }}" alt="Image of {{ $head['name'] }}">
                                <div class="p-6">
                                    <hr class="border-green-300">
                                    <h2 class="text-xl font-semibold text-green-800">{{ $head['name'] }}</h2>
                                    <p class="text-green-600 mt-2">{{ $head['title'] }}</p>
                                    <hr class="border-green-300">
                                </div>
                            </div>
                        </div>
